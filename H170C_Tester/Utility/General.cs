    ...
    public static class General
    {
        ...
        private static List<string> MakePassTestData()//TODO:
        {
            var ListData = new List<string>
            {
                ...
                State.VmTestResults.HueLed1R,
                State.VmTestResults.HueLed2R,
                State.VmTestResults.HueLed3R,
                State.VmTestResults.HueLed4R,
                State.VmTestResults.HueLed5R,
                State.VmTestResults.HueLed6R,
                State.VmTestResults.HueLed7R,
                State.VmTestResults.HueLed8R,
                State.VmTestResults.HueLed9R,
                State.VmTestResults.HueLed10R,
                State.VmTestResults.HueLed11R,
                State.VmTestResults.HueLed12R,
                State.VmTestResults.HueLed13R,
                State.VmTestResults.HueLed14R,

                State.VmTestResults.HueLed1G,
                State.VmTestResults.HueLed2G,
                State.VmTestResults.HueLed3G,
                State.VmTestResults.HueLed4G,
                State.VmTestResults.HueLed5G,
                State.VmTestResults.HueLed6G,
                State.VmTestResults.HueLed7G,
                State.VmTestResults.HueLed8G,
                State.VmTestResults.HueLed9G,
                State.VmTestResults.HueLed10G,
                State.VmTestResults.HueLed11G,
                State.VmTestResults.HueLed12G,
                State.VmTestResults.HueLed13G,
                State.VmTestResults.HueLed14G,

                State.VmTestResults.HueLed1B,
                State.VmTestResults.HueLed2B,
                State.VmTestResults.HueLed3B,
                State.VmTestResults.HueLed4B,
                State.VmTestResults.HueLed5B,
                State.VmTestResults.HueLed6B,
                State.VmTestResults.HueLed7B,
                State.VmTestResults.HueLed8B,
                State.VmTestResults.HueLed9B,
                State.VmTestResults.HueLed10B,
                State.VmTestResults.HueLed11B,
                State.VmTestResults.HueLed12B,
                State.VmTestResults.HueLed13B,
                State.VmTestResults.HueLed14B,
